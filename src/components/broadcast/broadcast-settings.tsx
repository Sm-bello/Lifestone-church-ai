...
export function BroadcastSettings({
  ...
  const [ndiSourceName, setNdiSourceName] = useState("Lifestone Output")
  ...
  const [altNdiSourceName, setAltNdiSourceName] = useState("Lifestone Alt")
          ...
          <div className="rounded-lg border border-border bg-card p-4 space-y-4">
            ...
            {altOutputType === "display" ? (
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-1.5">
                  <label className="text-xs text-muted-foreground">Source Name</label>
                  <Input value={altNdiSourceName} onChange={(e) => setAltNdiSourceName(e.target.value)} placeholder="Lifestone Alt" />
                </div>
                <Button
                  variant="outline"
                  size="sm"
