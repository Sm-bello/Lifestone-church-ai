...
use lifestone_detection::{DetectionPipeline, MergedDetection, ReadingMode};
...
fn source_to_string(source: &lifestone_detection::DetectionSource) -> String {
    match source {
        lifestone_detection::DetectionSource::DirectReference => "direct".to_string(),
        lifestone_detection::DetectionSource::Semantic { .. } => "semantic".to_string(),
    }
}
