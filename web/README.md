# Lifestone marketing site

Next.js 16 marketing site for [Lifestone](https://openrhema.com). Static-only — no API routes, no server actions. Deployed to GitHub Pages on push to `main`.
